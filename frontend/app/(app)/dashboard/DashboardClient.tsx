    ...
    <>
      ...
      <section className="relative rounded-xl">
        ...
        <div className="mt-6 border-t border-border pt-6">
          <div className="flex items-center gap-4 rounded-xl border border-border bg-background px-5 py-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm text-text">{aiInsight}</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-3">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-text-muted">
                +{totalAnalysesThisMonth} this month
              </p>
            </div>
          </Link>
          ...
          <Link
            href={
              mostRecent ? `/report/${mostRecent.id}/ats-score` : "/analyze"
            }
            className="border border-border p-4 rounded-xl flex flex-col gap-2.5 hover:bg-gray-50 transition-colors group"
          >
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary/10">
            ...
            {[
              {
                ...
                desc: "View the critical learning path to secure your target role.",
                href: "/roadmap",
                icon: Map,
              },
              {
              ...
              },
              {
                ...
                href: sampleAnalysisId
                  ? `/report/${sampleAnalysisId}`
                  : "/analyses",
                icon: FileText,
              },
              {
