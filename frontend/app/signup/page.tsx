...
export default function SignupPage() {
  ...
  async function handleEmailSignup(e: React.FormEvent) {
    e.preventDefault();
    if (!agreed) {
      setError("Please agree to the data usage terms first.");
      return;
    }
  ...
  return (
    <AuthLayout headline="Create your workspace" subhead="Get started">
      {sent ? (
          ...
          <form onSubmit={handleEmailSignup} className="space-y-4">
            ...
            <label className="flex items-start gap-2 text-xs text-white/60">
              <input
                ...
                className="mt-0.5"
              />
              I agree to use my career data only for generating my analyses.
            </label>
